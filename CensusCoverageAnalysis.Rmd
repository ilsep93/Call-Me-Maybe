...
## Household: Standard error of means
...
Adding standard error of means.
```{r}
table2 %<>%
...
- line graph of cellphone owernship (latinobarometer)
-automate table with se at the bottom of means
